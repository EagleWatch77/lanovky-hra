...
<img
     ...
     {okno === "krystaly" && (
  <WindowModal title="Kryštály" onClose={() => setOkno(null)}>
      ...
      {okno === "ceny" && (
       ...
       <CenyOkno stanica={stanica} budovy={budovy} zmenitCenu={zmenitCenu} zmenitPrevadzkovuDobu={zmenitPrevadzkovuDobu} zmenitCenyStrediska={zmenitCenyStrediska} kupitAutoCeny={kupitAutoCeny} />
        </WindowModal>
      )}
      ...
      <div style={listaStyl}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, minWidth: 0 }}>
          ...
          <TopBar
            ...
            onKliknutePeniaze={() => prepnutPanel("peniaze")}
            peniazeRozbalene={otvorenyPanel === "peniaze"}
          />
        </div>
...
<UdalostiPanel stanica={stanica} onOtvorZamestnanci={() => { setZamestnanciZalozka("odbory"); setOkno("zamestnanci"); }} />
      </div>
