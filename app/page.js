...
export default function PrehladPage() {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, overflow: "hidden", background: "#05090d" }}>
     ...
     <div style={{ position: "absolute", top: 12, left: 100, zIndex: 3, height: 46, boxSizing: "border-box", display: "flex", alignItems: "center", background: "rgba(13,20,27,0.75)", borderRadius: 12, border: "1px solid rgba(0,0,0,0.5)", padding: "6px 12px" }}>
<TopBar
          stanica={stanica}
          budovy={budovy}
          efektivitaBudovy={efektivitaBudovy}
