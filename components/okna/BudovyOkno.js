...
const jeRatrak = kategoria === "ratrak";
  const jeHotel = kategoria === "hotel";
  const ponuka = jeLanovka
    ...
    : jeRatrak
    ? RATRAKY_PRE_ZONU[zona] || Object.keys(KATEGORIE[kategoria].katalog)
    : jeHotel
    ? HOTELY_PRE_ZONU[zona] || Object.keys(KATEGORIE[kategoria].katalog)
            ...
            {ponuka.map((typ) => {
              ...
              return (
               ...
               <div style={{ display: "flex", alignItems: "center", gap: 11, minWidth: 0 }}>
                                  {(OBRAZKY_LANOVIEK[typ] || OBRAZKY_PARKOVISK[typ] || OBRAZKY_UBYTOVANIA[typ] || OBRAZKY_SLUZIEB[typ] || OBRAZKY_POKLADNI[typ] || OBRAZKY_SERVISU[typ] || OBRAZKY_RATRAKOV[typ] || OBRAZKY_ZASNEZOVANIA[typ]) && (
                      <span
                        style={{
                          width: 64,
                          height: 64,
