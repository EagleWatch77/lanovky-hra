...
export default function TopBar({ stanica, budovy, efektivitaBudovy, onKliknutePrestiz, prestizRozbalena, pocetTuristov, spokojnostCelkova, onKliknuteSpokojnost, spokojnostRozbalena, onKliknuteDatum, datumRozbaleny }) {
