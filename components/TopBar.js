...
export default function TopBar({ stanica, budovy, efektivitaBudovy, onKliknutePrestiz, prestizRozbalena, pocetTuristov, spokojnostCelkova, onKliknuteSpokojnost, spokojnostRozbalena }) {
  ...
  return (
    ...
    <Stat label="😊 Spokojnosť" value={Math.round((spokojnostCelkova ?? 1) * 100) + " %"} />
