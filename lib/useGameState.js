...
export function useGameState() {
  ...
  // Základná prestíž za samotné postavenie — pevná, nezávislá od efektivity (jednorazovo za to, že budova stojí)
      ...
      if (jeLanovkaSTuristami) const prestizNaTuristu = 2 + 6 * Math.pow(turistiInfo[b.id].spokojnostFaktorB, 2); // 2-8, exponenciálne — malé rozdiely na vrchole = väčší rozdiel v bodochconst prestizNaTuristu = 2 + 6 * turistiInfo[b.id].spokojnostFaktorB; // 2-8 podľa spokojnosti, 5 je stred
