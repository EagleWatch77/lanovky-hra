...
import { podielOtvorenychLanoviek } from "./pocasie";
...
export function useGameState() {
  ...
  async function nacitajVsetko() {
    ...
    const podielLanoviek = podielOtvorenychLanoviek(hDatum);
    for (const b of hotoveTeraz) {
      ...
      if (b.cena && KATEGORIE[b.kategoria].maCenu) {
        const vietorMultiplikator = b.kategoria === "lanovka" ? podielLanoviek : 1;
