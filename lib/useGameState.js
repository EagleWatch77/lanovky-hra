...
const hodnotaBudov = hotoveTeraz.reduce((s, b) => s + cenaBudovy(b.kategoria, b.typ, b.znacka), 0);
    const rok = hernyRok(vekDni);
    const udrzbaHodinovo = udrzbaZaHodinu(hodnotaBudov, rok);
    ...
    let zarobene = Math.round(celkovyPrijem - celkoveNakladyPlaty - nakladyNaNajatie - nakladyUdrzbaSuma);
