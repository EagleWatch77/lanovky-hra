...
export const ZNACKY_LANOVKY = {
  alpinor: { nazov: "Alpinor", ikona: "💎", popis: "Prémiová, najspoľahlivejšia", cenaMod: 1.2, prestizMod: 1.25 },
  montera: { nazov: "Montera", ikona: "🚡", popis: "Vyvážená, bezpečná voľba", cenaMod: 1.0, prestizMod: 1.0 },
  nordtech: { nazov: "Nordtech", ikona: "⚙️", popis: "Lacnejšia, riskantnejšia", cenaMod: 0.85, prestizMod: 0.9 },
};
...
export const ZNACKY_RATRAKY = {
  snowtrac: { nazov: "Snowtrac", ikona: "🚜", popis: "Lacnejší nákup, vyššia údržba", cenaMod: 1.0, prestizMod: 1.0 },
  pistenwolf: { nazov: "Pistenwolf", ikona: "🐺", popis: "Drahší, ale spoľahlivejší", cenaMod: 1.27, prestizMod: 1.1 },
};
...
export const KATEGORIE = {
  ...
  pokladna: { nazov: "Pokladne", ikona: "🎫", katalog: POKLADNE_TYPY, znackyKatalog: null, maCenu: false, obrazokLeto: "/zona-luka/budova-pokladna-leto.png?v=2", obrazokZima: "/zona-luka/budova-pokladna-zima.png?v=2" },
...
export const ZONY = {
  luka: {
    ...
    ikona: "🌾",
    poradie: 1,
    limity: { vlek: 2, lanovka: 1, parkovisko: 1, bar: 1, hotel: 2, pokladna: 1 },
