...
export const LANOVKY_TYPY = {
  vlek: {
    ...
    zakladnaCena: 300000, vystavbaHernychMesiacov: 1, kapacita: 12, prestiz: 40, referencnaCena: 15, zamestnanci: 3,
    celorocne: false,
  },
  sedacka_2: {
    nazov: "2-sedačka (pevná)",
    popis: "Najlacnejšia sedačková lanovka. Pomalá, ale spoľahlivá.",
    zakladnaCena: 550000, vystavbaHernychMesiacov: 3, kapacita: 15, prestiz: 60, referencnaCena: 17, zamestnanci: 5,
    celorocne: false,
  },
  sedacka_4: {
    nazov: "4-sedačka (pevná)",
    popis: "Osvedčený štandard. Dobrý pomer ceny a kapacity.",
    zakladnaCena: 850000, vystavbaHernychMesiacov: 4, kapacita: 25, prestiz: 95, referencnaCena: 19, zamestnanci: 7,
    celorocne: false,
  },
  sedacka_4_odp: {
    nazov: "4-sedačka (odpojiteľná)",
    popis: "Rýchlejšia a pohodlnejšia. Vyššia údržba.",
    zakladnaCena: 1200000, vystavbaHernychMesiacov: 5, kapacita: 35, prestiz: 120, referencnaCena: 21, zamestnanci: 8,
    celorocne: false,
  },
  sedacka_6_odp: {
    nazov: "6-sedačka (odpojiteľná)",
    popis: "Vysoká kapacita pre hlavné zjazdovky.",
    zakladnaCena: 1800000, vystavbaHernychMesiacov: 6, kapacita: 50, prestiz: 160, referencnaCena: 23, zamestnanci: 10,
    celorocne: false,
  },
  sedacka_8_odp: {
    nazov: "8-sedačka (odpojiteľná)",
    popis: "Špičková sedačková lanovka. Prevezie obrovský nápor.",
    zakladnaCena: 2600000, vystavbaHernychMesiacov: 7, kapacita: 65, prestiz: 200, referencnaCena: 25, zamestnanci: 12,
    celorocne: false,
  },
  kabinka_8: {
    nazov: "Kabínka 8-miestna",
    popis: "Gondola s uzavretými kabínami.",
    zakladnaCena: 2200000, vystavbaHernychMesiacov: 7, kapacita: 55, prestiz: 190, referencnaCena: 24, zamestnanci: 11,
    celorocne: true,
  },
  kabinka_10: {
    nazov: "Kabínka 10-miestna",
    popis: "Väčšia gondola pre hlavné prepojenia strediska.",
    zakladnaCena: 3000000, vystavbaHernychMesiacov: 8, kapacita: 75, prestiz: 230, referencnaCena: 26, zamestnanci: 13,
    celorocne: true,
  },
  kabinka_15: {
    nazov: "Kabínka 15-miestna",
    popis: "Veľkokapacitná gondola. Chrbtica moderného strediska.",
    zakladnaCena: 4200000, vystavbaHernychMesiacov: 10, kapacita: 95, prestiz: 280, referencnaCena: 28, zamestnanci: 16,
    celorocne: true,
  },
  lanovka_3s: {
    nazov: "3S lanovka",
    popis: "Trojlanová lanovka. Zdolá extrémne prevýšenie aj vietor.",
    zakladnaCena: 6500000, vystavbaHernychMesiacov: 12, kapacita: 115, prestiz: 400, referencnaCena: 32, zamestnanci: 20,
    celorocne: true,
  },
  funitel: {
    nazov: "Funitel",
    popis: "Dve laná blízko seba. Najodolnejšia voči vetru.",
    zakladnaCena: 5500000, vystavbaHernychMesiacov: 11, kapacita: 100, prestiz: 350, referencnaCena: 30, zamestnanci: 18,
    celorocne: true,
  },
  kabinka_20: {
    nazov: "Kabínka 20-miestna",
    popis: "Špičková gondola s obrovskou priepustnosťou.",
    zakladnaCena: 5000000, vystavbaHernychMesiacov: 11, kapacita: 115, prestiz: 320, referencnaCena: 30, zamestnanci: 18,
    celorocne: true,
  },
  kyvadlova_100: {
    nazov: "Kyvadlová lanovka",
    popis: "Dve obrovské kabíny pre 100 osôb. Symbol veľkého strediska.",
    zakladnaCena: 9000000, vystavbaHernychMesiacov: 14, kapacita: 140, prestiz: 500, referencnaCena: 35, zamestnanci: 24,
    celorocne: true,
  },
};
...
export const OBRAZKY_UBYTOVANIA = {
  ...
  horska_chata: "/ubytovanie/horska-chata_transparent.png",
  panoramaticky_rezort: "/ubytovanie/panoramaticky-rezort_transparent.png",
};
...
export const HOTELY_TYPY = {
  ...
  horska_chata: {
    nazov: "Horská chata",
    popis: "Kamenná chata na skalnatom vrchole. Výnimočné miesto s výhľadom.",
    zakladnaCena: 3500000, vystavbaHernychMesiacov: 20, kapacita: 40, prestiz: 250, referencnaCena: 150, zamestnanci: 12,
  },
  panoramaticky_rezort: {
    nazov: "Panoramatický rezort",
    popis: "Presklená veža na vrchole s vlastnou stanicou lanovky.",
    zakladnaCena: 6000000, vystavbaHernychMesiacov: 24, kapacita: 70, prestiz: 400, referencnaCena: 200, zamestnanci: 20,
    premiova: true,
  },
};

// Ktoré hotely sa dajú stavať v ktorej zóne
export const HOTELY_PRE_ZONU = {
  udolie: ["hotel_3", "hotel_4", "hotel_5", "summit_resort"],
  hory: ["horska_chata", "panoramaticky_rezort"],
  ladovec: ["horska_chata", "panoramaticky_rezort"],
};
...
// --- Vývoj konkurencie ---
// Konkurencia rastie spolu so strediskom: čím viac turistov, tým väčšie budovy stavia.
// Vyššia úroveň berie viac dopytu, ale zároveň dáva vyššiu prestíž celej oblasti.
export const KONKURENCIA_UROVNE = {
  1: { stratapenazi: 0.25, prestizNasobok: 1.0, nazov: "malá" },
  2: { stratapenazi: 0.32, prestizNasobok: 1.5, nazov: "stredná" },
  3: { stratapenazi: 0.40, prestizNasobok: 2.2, nazov: "veľká" },
};

// Ktoré kategórie konkurencie sa vyvíjajú
export const KONKURENCIA_VYVIJA_SA = ["hotel", "bufet", "parkovisko"];

// Pri koľkých turistoch denne prejde konkurencia na vyššiu úroveň
export const KONKURENCIA_HRANICE = { 2: 800, 3: 2500 };

// Konkurencia môže prestavovať najviac raz za herný rok (= 182,625 reálneho dňa)
export const KONKURENCIA_PAUZA_DNI = 182.625;

// Obrázky konkurenčných budov podľa úrovne
export const OBRAZKY_KONKURENCIE = {
  parkovisko: {
    1: "/parkoviska/strkove-parkovisko.png",
    2: "/parkoviska/asfaltove-parkovisko.png",
    3: "/parkoviska/parkovaci-dom.png",
  },
  bufet: {
    1: "/sluzby/bufet.png",
    2: "/sluzby/bufet.png",
  ...
  hotel: {
    1: "/ubytovanie/3hviezdy-hotel_transparent.png",
    2: "/ubytovanie/4hviezdy-hotel_transparent.png",
    3: "/ubytovanie/5hviezdy-hotel_transparent.png",
  },
  penzion: { 1: "/ubytovanie/penzion.png" },
  bar: { 1: "/sluzby/apreskibar.png" },
  servis: { 1: "/sluzby/skiservis_transparent.png" },
};

// Akú úroveň má konkurencia dosiahnuť podľa návštevnosti strediska
export function cielovaUrovenKonkurencie(dennyPocetTuristov) {
  if (dennyPocetTuristov >= KONKURENCIA_HRANICE[3]) return 3;
  if (dennyPocetTuristov >= KONKURENCIA_HRANICE[2]) return 2;
  return 1;
}

// Konkurencia dobieha hráča — ak postaví lepší typ, ona ide o stupeň pod neho
export function urovenPodlaHraca(hotoveBudovy, kategoria) {
  const budovy = hotoveBudovy.filter((b) => b.kategoria === kategoria);
  if (budovy.length === 0) return 1;
  const katalog = KATEGORIE[kategoria]?.katalog || {};
  const najdrahsia = Math.max(...budovy.map((b) => katalog[b.typ]?.zakladnaCena || 0));
  const vsetkyCeny = Object.values(katalog).map((t) => t.zakladnaCena).sort((a, b) => a - b);
  const poradie = vsetkyCeny.indexOf(najdrahsia);
  if (poradie >= 2) return 3;
  if (poradie >= 1) return 2;
  return 1;
}
...
// --- Kryštály (prémiová mena) ---
// Kurz: 1 € = 50 kryštálov
export const KURZ_KRYSTALOV = 50;

export const OBRAZOK_KRYSTAL = "/premium/krystal_transparent.png";
export const OBRAZOK_KRYSTALY = "/premium/3krystaly_transparent.png";

// Balíčky na kúpu (väčší balíček = viac bonusu)
export const BALICKY_KRYSTALOV = [
  { eur: 5, krystalov: 250, bonus: 0 },
  { eur: 10, krystalov: 550, bonus: 10 },
  { eur: 20, krystalov: 1200, bonus: 20 },
  { eur: 50, krystalov: 3250, bonus: 30 },
  { eur: 100, krystalov: 7000, bonus: 40 },
];

// Koľko kryštálov stojí prémiová budova
export const CENY_V_KRYSTALOCH = {
  sedacka_8_odp: 700,
  kabinka_20: 800,
  kyvadlova_100: 1000,
  summit_resort: 900,
  panoramaticky_rezort: 800,
  zasnezovanie_nadrz: 400,
  parkovaci_dom: 350,
  ratrak_premium: 250,
};

// --- Automatické ceny (prémiová funkcia) ---
// Hráč nemusí chodiť každý týždeň prestavovať ceny — hra to spraví za neho.
export const AUTO_CENY_SEZONA_KRYSTALOV = 300;
export const AUTO_CENY_ROK_KRYSTALOV = 500;

// Automatika trafí cenu presnejšie než hráčov odhad (±10 % namiesto ±25 %)
export const AUTO_CENY_ODCHYLKA = 0.1;

// Cena, ktorú automatika nastaví — okolo skutočnej referenčnej hodnoty
export function autoCena(stanicaId, kategoria, typ, tyzdenIndex, refCenaDnes) {
  if (!refCenaDnes) return null;
  const seed = jednoduchyHash(`${stanicaId}-auto-${kategoria}-${typ}-${tyzdenIndex}`);
  const odchylka = 1 - AUTO_CENY_ODCHYLKA + ((seed % 1000) / 1000) * (AUTO_CENY_ODCHYLKA * 2);
  return Math.max(1, Math.round(refCenaDnes * odchylka));
}

export function cenaVKrystaloch(typ) {
  return CENY_V_KRYSTALOCH[typ] || 0;
}

// --- Postava riaditeľa v profile ---
// Mení sa podľa najvyššej odomknutej zóny — hráč vidí, ako rastie.
export const OBRAZKY_RIADITELA = {
  muz: {
    luka: "/riaditel/riaditel-luka_transparent.png",
    udolie: "/riaditel/riaditel-udolie_transparent.png",
    hory: "/riaditel/riaditel-hory_transparent.png",
    ladovec: "/riaditel/riaditel-ladovec_transparent.png",
  },
  zena: {
    luka: "/riaditel/riaditelka-luka_transparent.png",
    udolie: "/riaditel/riaditelka-udolie_transparent.png",
    hory: "/riaditel/riaditelka-hory_transparent.png",
    ladovec: "/riaditel/riaditelka-ladovec_transparent.png",
  },
};

export function obrazokRiaditela(stanica) {
  const pohlavie = stanica?.pohlavie === "zena" ? "zena" : "muz";
  let zona = "luka";
  if (stanica?.ladovec_odomknuty) zona = "ladovec";
  else if (stanica?.hory_odomknute) zona = "hory";
  else if (stanica?.udolie_odomknute) zona = "udolie";
  return OBRAZKY_RIADITELA[pohlavie][zona];
}

// --- Pozvánky ---
// Odmena sa vyplatí až keď pozvaný naozaj hrá — nie hneď po registrácii.
export const POZVANKA_ODMENA_POZYVAJUCI = 100;
export const POZVANKA_ODMENA_POZVANY = 50;
export const POZVANKA_PODMIENKA_PRESTIZ_BUDOVY = 300;
export const POZVANKA_PODMIENKA_DNI = 30;

// --- Automatické ceny (prémiová funkcia) ---
export const KRYSTALY_ZA_MILNIK = {
  prva_lanovka: 25,
  udolie: 50,
  hory: 100,
  ladovec: 200,
...
export function konkurencnyMultiplikator(kategoria, zona, pocetKonkurencie, urovne = {}) {
  const cfg = KONKURENCIA_ZONY_KONFIG[zona]?.[kategoria];
  if (!cfg || !pocetKonkurencie) return 1;
  const kluc = `${zona}:${kategoria}`;
  const pocet = pocetKonkurencie[kluc] || 0;
  if (pocet === 0) return 1;
  const uroven = urovne[kluc] || 1;
  const strata = KONKURENCIA_UROVNE[uroven]?.stratapenazi ?? cfg.stratapenazi;
  return Math.max(0, 1 - strata * pocet);
}

export function konkurencnaPrestiz(pocetKonkurencie, urovne = {}) {
  ...
  for (const zona of Object.keys(KONKURENCIA_ZONY_KONFIG)) {
    for (const kat of Object.keys(KONKURENCIA_ZONY_KONFIG[zona])) {
      ...
      if (pocet === 0) continue;
      const uroven = urovne[kluc] || 1;
      const nasobok = KONKURENCIA_UROVNE[uroven]?.prestizNasobok ?? 1;
      sucet += pocet * KONKURENCIA_ZONY_KONFIG[zona][kat].prestizBonus * nasobok;
    }
  }
  return Math.round(sucet);
}
...
// Nové stredisko má obdobie milosti — postihy sa nabiehajú postupne,
// aby začínajúci hráč nevidel hneď 40 % spokojnosť a nevedel prečo.
export const MILOST_DNI = 45;
export const NABEH_DNI = 15; // po milosti sa postihy naplno prejavia za ďalších 15 dní

export function faktorMilosti(vekDni) {
  if (vekDni <= MILOST_DNI) return 0;
  if (vekDni >= MILOST_DNI + NABEH_DNI) return 1;
  return (vekDni - MILOST_DNI) / NABEH_DNI;
}

export function vypocitajSpokojnostStrediska(hotoveBudovy, st, hDatum, globalnyMult, maZasnezovanie, jeBurka, jeSilnyVietor, zonaDennyDav = {}, zonaDopyt = {}, typPocasia = "zamracene", vekDni = 999) {
 ...
 // Preplnenie lanoviek — porovnáva sa DOPYT s kapacitou, berie sa najhoršia zóna.
  // Tolerancia rád závisí od počasia — v peknom sa rad znesie, v zlom nie.
  const tolerancia = toleranciaPreplnenia(typPocasia, jeBurka, jeSilnyVietor);
  let najhorsiePreplnenie = 0;
  for (const zonaKluc of Object.keys(zonaDopyt)) {
    ...
    const preplnenie = preplnenieZony(kapacitaZony, zonaDopyt[zonaKluc], tolerancia);
 ...
 // Obdobie milosti — nové stredisko postihy za infraštruktúru a služby zatiaľ necíti
  const milost = faktorMilosti(vekDni);
  infrastruktura *= milost;
  sluzby *= milost;
...
// --- Preplnenie zóny (kapacita lanoviek vs. dopyt po nej) ---
// Maximálne pustíme 150 % kapacity — nad to už ľudia odídu inam.
export const MAX_PREPLNENIE = 1.5;

// Do koľkých % kapacity ľudia rady tolerujú — závisí od počasia.
// V peknom počasí sa rad znesie, v zlom nasrdí aj pokojného človeka.
export function toleranciaPreplnenia(typPocasia, jeBurka, jeSilnyVietor) {
  if (jeBurka || jeSilnyVietor || typPocasia === "prsi") return 1.05;
  if (typPocasia === "slnecno" || typPocasia === "polojasno") return 1.3;
  return 1.2; // zamračené, sneží
}

// Vracia 0 (žiadne rady) až 1 (maximálne preplnené)
export function preplnenieZony(kapacitaZony, dopytVZone, tolerancia = 1.2) {
  if (kapacitaZony <= 0 || dopytVZone <= 0) return 0;
  const pomer = Math.min(MAX_PREPLNENIE, dopytVZone / kapacitaZony);
  if (pomer <= tolerancia) return 0;
  return Math.min(1, (pomer - tolerancia) / (MAX_PREPLNENIE - tolerancia));
}
