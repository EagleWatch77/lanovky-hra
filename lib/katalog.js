...
export const POKLADNE_TYPY = {
  pokladna_mala: {
    nazov: "Malá pokladňa",
    popis: "Jednoduchá búdka s jedným okienkom. Základné odbavenie.",
    zakladnaCena: 80000, vystavbaHernychMesiacov: 0.5, kapacita: 50, prestiz: 10, referencnaCena: 0, zamestnanci: 1,
  },
  pokladna_velka: {
    nazov: "Veľká pokladňa",
    popis: "Štyri okienka a prístrešok. Kratšie rady, spokojnejší hostia.",
    zakladnaCena: 250000, vystavbaHernychMesiacov: 1, kapacita: 150, prestiz: 25, referencnaCena: 0, zamestnanci: 3,
  },
  pokladna_infocentrum: {
    nazov: "Pokladňa s infocentrom",
    popis: "Moderná budova s informáciami a predajom skipasov.",
    zakladnaCena: 500000, vystavbaHernychMesiacov: 2, kapacita: 250, prestiz: 50, referencnaCena: 0, zamestnanci: 5,
  },
};
...
export const ZONY = {
  luka: {
    ...
    ikona: "🌾",
    poradie: 1,
    limity: { vlek: 2, lanovka: 1, spojnica_udolie: 1, spojnica_hory: 1, parkovisko: 1, bufet: 1, penzion: 2, pokladna: 1 },
  ...
  udolie: {
    ...
    ikona: "🏞️",
    poradie: 2,
    limity: { lanovka: 3, parkovisko: 2, hotel: 2, ratrak: 1, zasnezovanie: 1, bufet: 1, bar: 1, servis: 1 },
  },
  hory: {
    nazov: "Hory",
    ikona: "🌲",
    poradie: 3,
    limity: { lanovka: 2, spojnica_ladovec: 1, hotel: 1, bar: 1 },
