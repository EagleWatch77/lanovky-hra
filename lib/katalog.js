...
export const LANOVKY_TYPY = {
  ...
  vlek_bobova: { nazov: "Vlek + Bobová dráha", zakladnaCena: 450000, vystavbaHernychMesiacov: 1, kapacita: 30, prestiz: 50, referencnaCena: 15, zamestnanci: 3 },
...
export const ZONY = {
  luka: {
    ...
    ikona: "🌾",
    poradie: 1,
   limity: { vlek: 1, vlek_bobova: 1, lanovka_luka: 1, lanovka_do_hor: 1, parkovisko: 1, bar: 1, penzion: 2, pokladna: 1 },
    popisky: { bar: "Bufet" },
  },
  udolie: {
    nazov: "Údolie",
...
export function jeVlekMimoSezony(typ, mesiac) {
  return typ === "vlek" && !jeZimnyMesiac(mesiac); // "vlek_bobova" funguje aj v lete (bobová dráha)
}
